  ...
  const addNotice = async (e) => {
    ...
    try {
      ...
      setAlertConfig({
        ...
        message:
          "Your notice was submitted successfully! It will appear on the board once approved by an admin.",
        type: "success",
      });
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex justify-center items-center z-50 p-4">
          <div className="bg-white rounded-2xl p-6 max-w-lg w-full shadow-xl relative animate-in fade-in zoom-in duration-200">
            ...
            <p className="text-sm text-gray-500 mb-5">
              Your notice will be reviewed by an administrator before it is
              published to the public board.
            </p>
